...
class ButtonSliderVertical:
    ...
    def render(self, screen: pygame.Surface):
        # bar
        screen.fill((255, 255, 255), (self.x, self.y, self.stroke, self.length))

        # slider
        # pygame.draw.circle(screen, (255, 255, 255), (self.x + self.length * self.scroll_pos, self.y + self.stroke / 2), self.stroke * 2)
        pygame.draw.circle(screen, (255, 255, 255), (self.x + self.stroke / 2, self.y + self.length * self.scroll_pos), self.stroke * 2)
